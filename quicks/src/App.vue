<template>
  <div class="bg-primary-grey w-screen h-screen items-end justify-end fixed">
...
export default {
  ...
  data() {
    return {
      ...
      taskButtonSize: "60",
      menuButtonSize: "68",
      iconInboxFill: "#8785FF",
      iconTaskFill: "#F8B76B",
      buttonInboxFill: "bg-white",
      buttonTaskFill: "bg-white",
      buttonMenuFill: "bg-primary",
      menuAdditionalClass: "",
      inboxAdditionalClass: "",
      taskAdditionalClass: "",
    };
  },
  methods: {
  ...
  watch: {
    showTaskView: function (newVal, oldVal) {
      if (newVal !== oldVal) {
        this.iconTaskFill = newVal ? "white" : "#F8B76B";
        this.menuButtonSize = newVal ? "60" : "68";
        this.taskButtonSize = newVal ? "68" : "60";
        this.buttonTaskFill = newVal ? "bg-indicator-orange" : "bg-white";
        this.buttonMenuFill = newVal ? "bg-primary-dark-grey" : "bg-primary";
        this.menuAdditionalClass = newVal
          ? "absolute z-10 transform -translate-x-1/3 -translate-y-1"
          : "";
        this.taskAdditionalClass = newVal ? "order-last z-30" : "";
      }
    },
    showInboxView: function (newVal, oldVal) {
      if (newVal !== oldVal) {
        this.iconInboxFill = newVal ? "white" : "#8785FF";
        this.inboxButtonSize = newVal ? "68" : "60";
        this.menuButtonSize = newVal ? "60" : "68";
        this.buttonMenuFill = newVal ? "bg-primary-dark-grey" : "bg-primary";
